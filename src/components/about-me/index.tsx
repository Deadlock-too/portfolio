    ...
    <Boundary>
      <div className="grid gap-x-8 gap-y-6 md:grid-cols-[2fr,1fr]">
        ...
        <div className="text-focus-in prose prose-xl prose-slate prose-invert col-start-1">
          <p>Junior developer with almost <Highlight>4 years of experience</Highlight> on back-end.</p>
          ...
          <p>I approach work with a lot of <Highlight delay={1.575}>commitment</Highlight> and <Highlight delay={2.325}>enthusiasm</Highlight>, I consider myself a very curious person, always
            ready to improve by proactively listening to any constructive criticism. Once the objectives and the work
            context have been defined, I show good <Highlight delay={3.075}>autonomy</Highlight> in its continuation.</p>
        </div>
