...
const FoldingCardContainer = forwardRef<HTMLDivElement, FoldingCardProps>(
...
const FoldingCardInnerThirdAndFourthContentWrapper = forwardRef<HTMLDivElement, Omit<FoldingCardProps, 'isActive' | 'handleActive'>>(
  ({ className, children, ...props }, ref) => {
    return (
      <div
        ref={ ref }
